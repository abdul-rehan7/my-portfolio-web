...
const Education = () => {
  return (
    <div className="text-white flex flex-col items-center md:flex-row md:justify-evenly  md:py-7 py-10   space-y-20 bg-[#070707] md:space-y-36 ">
      <div className="first bg-[#ffffff1b] p-6 md:w-[35vw] w-[90vw] h-auto" data-aos="fade-right">
      ...
      <div className="Second bg-[#ffffff1b] p-6 md:w-[35vw] w-[90vw] h-auto" data-aos="fade-left">
